...
public class main {
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        String time = "T14:00:00.000"; //Время отправки ежедневного сообщения
        String chat_id = "-1001678094843"; //Новый 2021 = -1001436821018, Тестовый = -1001389593568 //НГ2022 = -1001678094843
